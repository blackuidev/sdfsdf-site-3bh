...
import { Mail, Lock, Car, Github } from "lucide-react";
      ...
      >
        <div className="w-full max-w-md mx-auto rounded-2xl p-8 shadow-input bg-black/40 backdrop-blur-sm border border-white/20">
          ...
          <p className="text-neutral-300 text-sm max-w-sm text-center mb-8">
            Welcome back to AutoLux. Login to access your premium experience.
          </p>
          ...
          <form className="my-8" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex flex-col space-y-4">
                <Button
                    className="relative group/btn flex space-x-2 items-center justify-center px-4 w-full text-white rounded-md h-10 font-medium shadow-input bg-zinc-900/80 border border-zinc-700 hover:bg-zinc-800"
                    type="button"
                >
